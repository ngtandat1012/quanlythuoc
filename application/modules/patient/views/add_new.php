                            ...
                            <section class="panel">
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="patient/addNew" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><?php echo ('Tên '); ?></label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><?php echo ('Lớp'); ?></label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><?php echo ('CCCD'); ?></label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><?php echo lang('Giới tính'); ?></label>

                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                            ...
                            <?php if (in_array('doctor', $this->modules)) { ?>
                                <!-- <li> <li class="sub-menu">
                                    <a href="javascript:;" >
                                        ...
                                        <span><?php echo ('Bác sĩ'); ?></span>
                                    </a>
                                    <ul class="sub">
                                        <li><a href="doctor"><i class="fa fa-user"></i><?php echo ('Danh sách bác sĩ'); ?></a></li>
                                        <li><a href="appointment/treatmentReport"><i class="fa fa-money"></i><?php echo('Lịch sử điều trị'); ?></a></li>
                                    </ul>
                                </li> -->
                            <?php } ?>
                        <?php } ?>
                        ...
                        <!-- <?php if ($this->ion_auth->in_group('admin')) { ?>
                            <li> <li class="sub-menu">
                                <a href="javascript:;" >
                                    <i class="fa fa-users"></i>
                                    <span><?php echo ('Nguồn nhân lực'); ?></span>
                                </a>
                                <ul class="sub">
                                    ...
                                    <?php if (in_array('pharmacist', $this->modules)) { ?>
                                        <li><a href="pharmacist"><i class="fa fa-user"></i><?php echo ('Dược sĩ'); ?></a></li>
                                    <?php } ?>
                            ...
                            <?php if (in_array('medicine', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        ...
                                        <li><a  href="medicine/medicineCategory"><i class="fa fa-edit"></i><?php echo ('Danh mục thuốc'); ?></a></li>
                                        <li><a  href="medicine/addCategoryView"><i class="fa fa-plus-circle"></i><?php echo ('Thêm danh mục'); ?></a></li>
                                        <!-- <li><a  href="medicine/medicineStockAlert"><i class="fa fa-plus-circle"></i><?php echo ('Cảnh báo kho thuốc'); ?></a></li> -->
                            ...
                            <?php if (in_array('email', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        ...
                                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                                            <li><a  href="email/settings"><i class="fa fa-gear"></i><?php echo ('settings'); ?></a></li>
                                        <?php } ?>
                                    </ul>
                                </li> 
                            <?php } ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                            <li> <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a href="settings"><i class="fa fa-gear"></i><?php echo ('cài đặt hệ thống'); ?></a></li>

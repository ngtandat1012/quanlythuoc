                        ...
                        <form role="form" action="prescription/addNewPrescription" class="clearfix" method="post" enctype="multipart/form-data">
                            <div class="">
                                <div class="form-group col-md-4">
                                    <label for="exampleInputEmail1"> <?php echo ('Ngày'); ?></label>
                                    ...
                                    <select class="form-control m-bot15 js-example-basic-single" name="patient" value=''>
                                        <?php foreach ($patients as $patient) { ?>
                                           ...
                                           if (!empty($prescription_patient)) {
                                               echo $prescription_patient->address;
                                           }
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.each($('select.medicinee option:selected'), function () {
         ...
         <div class = "form-group medicine_sect col-md-3"><div class=col-md-12>\n\
...
\n\
<div class = "form-group medicine_sect col-md-3" ><div class=col-md-12>\n\
<label><?php echo ("Số lượng"); ?> </label>\n\
</div>\n\
\n\
\n\
\n\
\n\
<div class=col-md-12><input class = "potency medi_div quantity" id="quantity' + count + '" name = "days[]" value = "' + days + '" placeholder="1 " required>\n\
</div>\n\
</div>\n\
\n\
\n\
...
<div class=col-md-12><input class = "state medi_div" name = "dosage[]" value = "" placeholder="1" >\n\
 </div>\n\
 </div>\n\
\n\
<div class = "form-group medicine_sect col-md-0"><div class=col-md-12>\n\
\n\
</div>\n\
\n\
\n\
